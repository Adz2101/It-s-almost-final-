        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($isAdmin) {
                ...
                if ($category && $riskMapping) {
                    ...
                    if ($risk_id) {
                        echo "<td><a href='plan-mitigation.php?risk_id={$risk_id}&category={$category}&riskMapping={$riskMapping}&id={$r_id}' class='btn-plan-mitigation' data-risk-id='{$row['id']}'>Plan Mitigation</a></td>";
                    } else {
